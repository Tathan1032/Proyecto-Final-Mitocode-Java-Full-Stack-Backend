...
public class SignoController {
	...
	public ResponseEntity<Page<Signo>> listarPageable(Pageable pageable) throws Exception{
		...
		return new ResponseEntity<Page<Signo>>(pacientes, HttpStatus.OK);
		
	}
	
	@PostMapping
	public ResponseEntity<Signo> registrar(@Valid @RequestBody Signo s) throws Exception {
		
		Signo obj = service.registrar(s);
	...
	@PutMapping
	public ResponseEntity<Signo> modificar(@Valid @RequestBody Signo s) throws Exception {
		
		Signo obj = service.modificar(s);
